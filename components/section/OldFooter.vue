        ...
        <ARow :gutter="[24, 24]" align="middle">
          ...
          <ACol span="7" :xl="7" :lg="10" :xs="24">
            <a href="#!" class="section-contact">
              ...
              <div class="section-contact__info">
                <span class="section-contact__label"> {{ $t("address") }} </span>
          ...
          <ACol span="5" :xl="5" :lg="7" :md="12" :xs="24">
            <a href="#!" class="section-contact">
              ...
              <div class="section-contact__info">
                <span class="section-contact__label"> {{ $t("footer.ourNumbers") }} </span>
                <span class="section-contact__value" v-if="setting.phone">
                  {{ setting.phone }}
                </span>
                <span class="section-contact__value" v-if="setting.phone2">
                  {{ setting.phone2 }}
                </span>
              </div>
            </a>
          ...
          <ACol span="5" :xl="5" :lg="7" :md="12" :xs="24">
            <a href="#!" class="section-contact">
              ...
              <div class="section-contact__info">
                <span class="section-contact__label"> {{ $t("footer.sendEmail") }} </span>
                <span class="section-contact__value">
                  {{ setting.email }}
                </span>
              </div>
        ...
        <ARow :gutter="[24, 32]">
          ...
          <ACol span="5" :lg="5" :md="8" :xs="12">
            <div class="section-item">
              <span class="section-item__label">{{ $t("footer.quickLinks") }}</span>
          ...
          <ACol :lg="5" :md="8" :xs="12">
            <div class="section-item">
              <span class="section-item__label">{{ $t("footer.ourServices") }}</span>
              <ul class="section-menu">
                <li class="section-menu__item" v-for="item in service.slice(0, 6)">
                  <NuxtLink class="section-menu__link" :to="localePath(`/service/${item.slug}`)">
                    {{ item.title }}
                  </NuxtLink>
                </li>
              </ul>
          ...
          <ACol :lg="5" :md="8" :xs="12">
            <div class="section-item">
              <span class="section-item__label">{{ $t("footer.openingHours") }}</span>
              <ul class="section-menu">
                ...
                <li class="section-menu__item" v-if="$t('footer.sunday')">
                  <a class="section-menu__link">
                    {{ $t("footer.sunday") }}
                  </a>
                </li>
