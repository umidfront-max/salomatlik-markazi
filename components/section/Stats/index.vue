			...
			<div class="stats-wrapper" data-aos="fade-up" data-aos-duration="500">
				<div class="stats-header">
					<h2 class="stats-title">
						{{ setting?.["home.statistics.title"]?.[locale] || "-" }}
					</h2>
					<p class="stats-text">
						{{ setting?.["home.statistics.text"]?.[locale] || "-" }}
					</p>
				</div>
				<div class="stats-grid">
					<div class="stats-item">
						<div class="stats-item__value">
							{{ setting?.["home.statistics.doctorsCount"]?.[locale] }}
						</div>
						<div class="stats-item__label">
							{{ setting?.["home.statistics.doctorsTitle"]?.[locale] }}
						</div>
					</div>
					<div class="stats-item">
						<div class="stats-item__value">
							{{ setting?.["home.statistics.patientsCount"]?.[locale] }}
						</div>
						<div class="stats-item__label">
							{{ setting?.["home.statistics.patientsTitle"]?.[locale] }}
						</div>
					</div>
					<div class="stats-item">
						<div class="stats-item__value">
							{{ setting?.["home.statistics.staffsCount"]?.[locale] }}
						</div>
						<div class="stats-item__label">
							{{ setting?.["home.statistics.staffsTitle"]?.[locale] }}
						</div>
					</div>
					<div class="stats-item">
						<div class="stats-item__value">
							{{
								setting?.[
									"home.statistics.internationalPatientsCount"
								]?.[locale]
							}}
						</div>
						<div class="stats-item__label">
							{{
								setting?.[
									"home.statistics.internationalPatientsTitle"
								]?.[locale]
							}}
						</div>
					</div>
