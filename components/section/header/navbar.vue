          ...
          <SectionHeaderLang>
            <template #="{ locale, locales }">
              <button class="menu-lang">
                <img class="menu-lang__flag" :src="`/flag/${locale}.png`" :alt="locale" />
    ...
    <div class="menu-container container">
      <ul class="menu-menu">
        <li class="menu-menu__item" v-for="item in menu" :key="item.id">
          <NuxtLink class="menu-menu__link" :to="localePath(item.page ? item.page : `/static/${item.slug}`)">{{
            item.title }}
          </NuxtLink>
        </li>
      </ul>
      ...
      <div class="menu-social">
        <a class="menu-social__icon" target="_blank" :href="item.site_url" v-for="item in social" :key="item.id">
          <Icon :name="item.icon" />
        </a>
      </div>
    </div>
