  ...
  <div class="widget">
    <Transition>
      <div v-if="isOpen" class="widget-items">
        <a
          :href="setting.address_link"
          target="_blank"
          class="widget-item"
          :style="getItemStyle(4)"
        >
          <Icon name="location" class="widget-item__icon" />
          <span class="widget-item__text">{{ $t("widget.ourAddress") }}</span>
        </a>

        <a
          href="https://wa.me/998998302888"
          target="_blank"
          class="widget-item"
        ...
        <button class="widget-item" :style="getItemStyle(2)" @click="openModal">
          <Icon name="telephone" class="widget-item__icon" />
          <span class="widget-item__text">{{ $t("widget.callback") }}</span>
        </button>
        <a
          href="https://t.me/Farhodmadad_Sadoqat_operator"
          target="_blank"
          class="widget-item"
          :style="getItemStyle(1)"
        >
          <Icon name="telegram" class="widget-item__icon" />
          <span class="widget-item__text">{{ $t("widget.sendMessage") }}</span>
        </a>
      </div>
    </Transition>
    <!-- Main Toggle Button -->
