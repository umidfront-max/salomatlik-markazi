  ...
  <section class="doctor-detail">
    ...
    <div class="doctor-detail__content">
      ...
      <div class="doctor-detail__actions">
        <Btn
          class="doctor-detail__btn"
          :data-text="$t('booking')"
          @click.stop="
            $router.push(
              localePath({
                query: { doctor_id: data.id },
              }),
            )
          "
        >
        ...
        <button
          class="doctor-detail__btn doctor-detail__btn--ghost"
          @click.stop="$router.push(localePath({ path: '/doctor/' + data.slug }))"
        >
          {{ $t("moreDetails") }}
        </button>
      </div>
