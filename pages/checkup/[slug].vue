...
const stats = [
  { icon: 'consultant',    value: '50K+', label: { uz: 'Bemorlar',    ru: 'Пациентов',     en: 'Happy Patients'  } },
  { icon: 'calendar',      value: '25+',  label: { uz: 'Yillik tajriba', ru: 'Лет опыта',  en: 'Years Experience'} },
  { icon: 'check-circle',  value: '100%', label: { uz: 'Sertifikatlangan', ru: 'Сертифицировано', en: 'Certified' } },
  { icon: 'star',          value: '4.9/5',label: { uz: 'Bemor reytingi', ru: 'Рейтинг',     en: 'Patient Rating'  } },
]

const aboutCards = [
  {
    icon: 'check-circle',
    title: { uz: 'Erta aniqlash',  ru: 'Раннее выявление', en: 'Early Detection' },
    text:  { uz: 'Salomatlik muammolarini jiddiy holatga aylanmasdan oldin aniqlang.',
  ...
  },
  {
    ...
    text:  { uz: "Salomatlik ko'rsatkichlarini muntazam kuzatib boring.",
  ...
  },
  {
    ...
    text:  { uz: 'Sizning ehtiyojlaringizga moslashtirilgan tavsiyalarni oling.',
...
const journeySteps = [
  {
    icon: 'calendar',
    title: { uz: 'Onlayn band qiling', ru: 'Онлайн запись', en: 'Book Online' },
    text:  { uz: "Qulay sana va vaqtni tanlang.", ru: 'Выберите удобную дату и время.', en: 'Choose your preferred date and time slot online.' },
  },
  {
    icon: 'check-circle',
    title: { uz: "Ro'yxatdan o'tish", ru: 'Регистрация', en: 'Registration' },
    text:  { uz: "Klinikamizda tezkor ro'yxatdan o'tish.", ru: 'Быстрая регистрация в современной клинике.', en: 'Quick check-in at our modern facility.' },
  },
  {
    icon: 'consultant',
    title: { uz: 'Tekshiruv', ru: 'Обследование', en: 'Tests & Consult' },
    text:  { uz: 'Barcha testlarni topshiring va shifokorlar bilan suhbatlashing.', ru: 'Пройдите все тесты и встретьтесь со специалистами.', en: 'Complete all tests and meet specialists.' },
    accent: true,
  },
  {
    icon: 'apply',
    title: { uz: 'Natijalar', ru: 'Результаты', en: 'Get Results' },
    text:  { uz: "Batafsil hisobot va davolash rejasi.", ru: 'Получите подробный отчёт и план действий.', en: 'Receive detailed report and action plan.' },
  },
]
...
const reviews = [
  {
    rating: 5,
    text:  { uz: "Ajoyib xizmat! Butun jarayon silliq va xodimlar professional edi.",
  ...
  {
    rating: 5,
    text:  { uz: "Juda batafsil tekshiruv. Shifokorlarning tushuntirishi yoqdi.",
  ...
  {
    rating: 5,
    text:  { uz: "Pulga arziydi. Chegirma yanada yaxshi qildi. Tavsiya qilaman!",
...
const staticTabs = [
  {
    ...
    headline: { uz: 'Kompleks diagnostika', ru: 'Комплексная диагностика', en: 'Comprehensive Diagnostic Tests' },
    sub:      { uz: 'Barcha testlar sertifikatlangan laboratoriyada bajariladi',
    ...
    items: [
      { emoji: '🩸', name: { uz: 'To‘liq qon tahlili (UQT)', ru: 'Общий анализ крови', en: 'Complete Blood Count (CBC)' }, cat: { uz: 'Gematologiya', ru: 'Гематология', en: 'Hematology' }, desc: { uz: 'Umumiy sog‘liqni baholash', ru: 'Оценка общего состояния здоровья', en: 'Evaluates overall health and detects disorders' } },
      { emoji: '🍯', name: { uz: 'Qondagi glyukoza testi',   ru: 'Анализ на глюкозу',      en: 'Blood Glucose Test'      }, cat: { uz: 'Diabet skriningi', ru: 'Скрининг диабета', en: 'Diabetes Screening' }, desc: { uz: 'Qondagi shakar darajasini o‘lchaydi', ru: 'Измеряет уровень сахара в крови', en: 'Measures blood sugar levels' } },
      { emoji: '❤️', name: { uz: 'Lipid profili',            ru: 'Липидный профиль',       en: 'Lipid Profile'           }, cat: { uz: 'Yurak-qon tomir', ru: 'Сердечно-сосудистый', en: 'Cardiovascular' }, desc: { uz: 'Xolesterin va triglitseridlarni tekshiradi', ru: 'Проверяет холестерин и триглицериды', en: 'Checks cholesterol and triglycerides' } },
      { emoji: '🦋', name: { uz: 'Qalqonsimon bez tahlili',   ru: 'Анализ щитовидной железы', en: 'Thyroid Function Test'  }, cat: { uz: 'Endokrinologiya', ru: 'Эндокринология', en: 'Endocrine' }, desc: { uz: 'Gormon darajalarini baholaydi', ru: 'Оценивает уровень гормонов', en: 'Assesses thyroid hormone levels' } },
      { emoji: '🫀', name: { uz: 'Jigar funksiyasi testi',    ru: 'Анализ функции печени',  en: 'Liver Function Test'      }, cat: { uz: 'Gepatologiya', ru: 'Гепатология', en: 'Hepatic' }, desc: { uz: 'Jigar sog‘ligini baholaydi', ru: 'Оценивает здоровье печени', en: 'Evaluates liver health and function' } },
      { emoji: '💧', name: { uz: 'Buyrak funksiyasi testi',   ru: 'Анализ функции почек',   en: 'Kidney Function Test'     }, cat: { uz: 'Nefrologiya', ru: 'Нефрология', en: 'Renal' }, desc: { uz: 'Buyrak ishini o‘lchaydi', ru: 'Измеряет работу почек', en: 'Measures kidney performance' } },
      { emoji: '🌟', name: { uz: 'D vitamini darajasi',        ru: 'Уровень витамина D',     en: 'Vitamin D Level'          }, cat: { uz: 'Ozuqaviy', ru: 'Питательный', en: 'Nutritional' }, desc: { uz: 'D vitamini yetishmovchiligini tekshiradi', ru: 'Проверяет дефицит витамина D', en: 'Checks vitamin D deficiency' } },
      { emoji: '📊', name: { uz: 'Elektrokardiogramma (EKG)', ru: 'Электрокардиограмма (ЭКГ)', en: 'Electrocardiogram (ECG)' }, cat: { uz: 'Kardiologiya', ru: 'Кардиология', en: 'Cardiac' }, desc: { uz: 'Yurak elektr faolligini qayd etadi', ru: 'Записывает электрическую активность сердца', en: 'Records heart electrical activity' } },
    ],
  },
  {
    key: 'CONSULTATION',
    label:    { uz: 'Konsultatsiyalar', ru: 'Консультации', en: 'Consultations' },
    headline: { uz: 'Mutaxassis konsultatsiyalari', ru: 'Консультации специалистов', en: 'Expert Consultations' },
    sub:      { uz: 'Tajribali shifokorlar bilan shaxsiy uchrashuvlar',
                ru: 'Личные встречи с опытными врачами',
                en: 'Personal consultations with board-certified specialists' },
    items: [
      { emoji: '🫀', name: { uz: 'Kardiolog konsultatsiyasi',    ru: 'Консультация кардиолога',    en: 'Cardiologist Consultation' }, cat: { uz: 'Yurak-qon tomir', ru: 'Сердечно-сосудистый', en: 'Cardiovascular' }, desc: { uz: 'Yurak salomatligini chuqur baholash', ru: 'Глубокая оценка здоровья сердца', en: 'In-depth evaluation of heart health' } },
      { emoji: '🧠', name: { uz: 'Nevrolog konsultatsiyasi',     ru: 'Консультация невролога',     en: 'Neurologist Consultation'  }, cat: { uz: 'Nevrologiya', ru: 'Неврология', en: 'Neurology' }, desc: { uz: 'Asab tizimi tekshiruvi', ru: 'Обследование нервной системы', en: 'Nervous system examination' } },
      { emoji: '🩺', name: { uz: 'Terapevt konsultatsiyasi',     ru: 'Консультация терапевта',     en: 'General Practitioner'      }, cat: { uz: 'Umumiy amaliyot', ru: 'Общая практика', en: 'General Practice' }, desc: { uz: 'Umumiy salomatlik bo‘yicha maslahat', ru: 'Общая консультация по здоровью', en: 'General health consultation' } },
      { emoji: '👁️', name: { uz: 'Oftalmolog konsultatsiyasi',  ru: 'Консультация офтальмолога',  en: 'Ophthalmologist Consult'   }, cat: { uz: 'Oftalmologiya', ru: 'Офтальмология', en: 'Ophthalmology' }, desc: { uz: 'Ko‘rish va ko‘z salomatligi', ru: 'Зрение и здоровье глаз', en: 'Vision and eye health check' } },
    ],
  },
]

const activeTab = ref('DIAGNOSTIC')
const currentTab = computed(() => staticTabs.find(t => t.key === activeTab.value) ?? staticTabs[0])

// Long description paragraphs (split by </p>)
...
<template>
  <div class="ck-page" v-if="checkup">
    <div class="container ck-page__inner">
        ...
        <div class="ck-panel">
          ...
          <div class="ck-panel__bottom">
            <div class="ck-panel__top-row">
              ...
              <span v-if="checkup.department?.title?.[locale]" class="ck-panel__gender">
      ...
      <!-- ══════════════════ STATS (4 cards) ══════════════════ -->
      <div class="ck-stats">
        <div v-for="(s, i) in stats" :key="i" class="ck-stat" :class="`ck-stat--${i}`">
      ...
      <!-- ══════════════════ ABOUT THIS PACKAGE ══════════════════ -->
      <div class="ck-about">
        <span class="ck-about__badge">{{ locale === 'uz' ? 'Paket haqida' : locale === 'ru' ? 'О пакете' : 'About This Package' }}</span>
      ...
      <div class="ck-tabs">
        <div class="ck-tabs__head">
          ...
          >
            <Icon
              :name="tab.key === 'CONSULTATION' ? 'consultant' : 'check-circle'"
        ...
        <Transition name="tab-fade" mode="out-in">
          <div class="ck-tabs__body" :key="currentTab.key">
            <h3 class="ck-tabs__title">{{ currentTab.headline[locale] }}</h3>
            ...
            <div class="ck-tabs__grid">
              ...
              >
                ...
                <div class="ck-test-card__body">
                  <h4 class="ck-test-card__name">{{ item.name[locale] }}</h4>
                  <span class="ck-test-card__cat">{{ item.cat[locale] }}</span>
                  <p class="ck-test-card__desc">{{ item.desc[locale] }}</p>
                </div>
      ...
      <div class="ck-journey">
        <h2 class="ck-journey__title">
          {{ locale === 'uz' ? "Tekshiruv jarayoningiz" : locale === 'ru' ? 'Ваш путь обследования' : 'Your Check-up Journey' }}
        </h2>
        <p class="ck-journey__sub">
          {{ locale === 'uz' ? 'Bandlikdan natijalar olishgacha qulay tajriba'
           : locale === 'ru' ? 'Удобный путь от записи до получения результатов'
           : 'A seamless experience from booking to results' }}
        </p>
        ...
        <div class="ck-journey__steps">
          ...
          >
            ...
            <h4 class="ck-journey__step-title">{{ step.title[locale] }}</h4>
            <p class="ck-journey__step-text">{{ step.text[locale] }}</p>
            <div v-if="i < journeySteps.length - 1" class="ck-journey__line" aria-hidden="true"></div>
          </div>
        </div>
        ...
        <div class="ck-journey__footer">
          <div class="ck-journey__info">
            <Icon name="clock" />
            <div>
              <b>{{ locale === 'uz' ? 'Umumiy davomiylik' : locale === 'ru' ? 'Общее время' : 'Total Process Time' }}</b>
              <span>{{ durationText || '2–3 hours' }}</span>
            </div>
          </div>
          <div class="ck-journey__info">
            <Icon name="apply" />
            <div>
              <b>{{ locale === 'uz' ? 'Natijalar' : locale === 'ru' ? 'Результаты' : 'Results Delivery' }}</b>
              <span>{{ locale === 'uz' ? '24–48 soat ichida' : locale === 'ru' ? 'В течение 24–48 часов' : 'Within 24–48 hours digitally' }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="ck-reviews">
        <h2 class="ck-reviews__title">
          {{ locale === 'uz' ? 'Bemorlarimiz fikrlari' : locale === 'ru' ? 'Отзывы пациентов' : 'What Our Patients Say' }}
        </h2>
        <p class="ck-reviews__sub">
          {{ locale === 'uz' ? "Minglab mamnun bemorlar tomonidan ishonchli"
           : locale === 'ru' ? 'Нам доверяют тысячи довольных пациентов'
      ...
      <div class="ck-cta">
        <div class="ck-cta__left">
          <h2 class="ck-cta__title">
            {{ locale === 'uz' ? "Salomatligingizni nazoratga oling" : locale === 'ru' ? 'Возьмите здоровье под контроль' : 'Ready to Take Control of Your Health?' }}
          </h2>
          <p class="ck-cta__sub">
            {{ locale === 'uz' ? "Bugun kompleks tekshiruvga yoziling va chegirmaga ega bo'ling."
             : locale === 'ru' ? 'Запишитесь сегодня и получите скидку на комплексное обследование.'
          ...
          <div v-if="checkup.price" class="ck-cta__price">
            ...
            <span v-if="hasDiscount" class="ck-cta__save">−{{ discountPercent }}%</span>
          </div>
        </div>
        <div class="ck-cta__right">
          <button class="ck-cta__btn ck-cta__btn--primary" @click="openModal">
            <Icon name="calendar" />
            {{ $t('apply.title') }}
          </button>
        </div>
...
.ck-page {
  ...
  &__inner { --width-container: 1180px; max-width: 1180px; }
}
...
.ck-feat {
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,0.18), 0 4px 12px rgba(0,0,0,0.08);
  ...
  &__body {
    ...
    flex-direction: column;
    gap: 2px;
    b    { font-size: 14.5px; font-weight: 700; color: #fff; line-height: 1.3; letter-spacing: 0.01em; }
    span { font-size: 12.5px; color: rgba(255,255,255,0.82); }
  }
}
...
.ck-stats {
  ...
  @include devices(md) { grid-template-columns: repeat(2, 1fr); gap: 12px; }
  @include devices(xs) { grid-template-columns: repeat(2, 1fr); }
}
...
.ck-stat {
  ...
  @include devices(xs) { padding: 14px 16px; gap: 10px; }
  ...
  &__icon {
    ...
    @include devices(xs) { width: 40px; height: 40px; :deep(svg) { width: 20px; height: 20px; } }
  }

  // Per-card icon colors (inspired by reference)
  &--0 &__icon { background: rgba(59,130,246,0.12); color: #3b82f6; }
  &--1 &__icon { background: rgba(34,197,94,0.12);  color: #22c55e; }
  &--2 &__icon { background: rgba(168,85,247,0.12); color: #a855f7; }
  &--3 &__icon { background: rgba(239,68,68,0.12);  color: #ef4444; }
...
.ck-about {
  ...
  @include devices(sm) { margin-top: 32px; padding: 28px 18px; }
  ...
  &__cards {
    ...
    @include devices(md) { grid-template-columns: 1fr; gap: 14px; margin-bottom: 24px; }
  }
  ...
  &__card {
    ...
    &--blue { background: linear-gradient(180deg, rgba(59,130,246,0.1) 0%, rgba(59,130,246,0.02) 100%); }
    &--red  { background: linear-gradient(180deg, rgba(239,68,68,0.1) 0%, rgba(239,68,68,0.02) 100%); }
  }
  ...
  &__card-icon {
    ...
    .ck-about__card--blue & { background: linear-gradient(135deg, #3b82f6, #1e40af); box-shadow: 0 8px 20px rgba(59,130,246,0.3); }
    .ck-about__card--red  & { background: linear-gradient(135deg, $red, #b91c1c);     box-shadow: 0 8px 20px rgba(239,68,68,0.3); }
...
.ck-tabs {
  ...
  &__tab {
    ...
    @include devices(xs) { padding: 14px 16px; font-size: 13px; }
  ...
  &__body { padding: 32px; @include devices(sm) { padding: 20px 16px; } }
  ...
  &__grid {
    ...
    @include devices(sm) { grid-template-columns: 1fr; }
  }
}
...
.ck-test-card {
  ...
  &__check {
    ...
    color: $primary;
    margin-top: 2px;
    :deep(svg) { width: 22px; height: 22px; fill: currentColor; stroke: currentColor; }
  }
}
...
.ck-journey {
  ...
  &__steps {
    ...
    @include devices(md) { grid-template-columns: repeat(2, 1fr); gap: 28px; }
  ...
  &__icon {
    ...
    .ck-journey__step:hover & { transform: scale(1.08); }
  ...
  &__line {
    ...
    @include devices(md) { display: none; }
  }
  ...
  &__footer {
    ...
    @include devices(xs) { grid-template-columns: 1fr; gap: 14px; padding: 16px; }
  }
  ...
  &__info {
    ...
    :deep(svg *) { fill: #60a5fa !important; stroke: #60a5fa !important; }
...
.ck-reviews {
  ...
  &__grid {
    ...
    @include devices(md) { grid-template-columns: 1fr; gap: 14px; }
  }
}
...
.ck-review {
  ...
  &__stars {
    ...
    :deep(.icon), :deep(svg) {
      ...
      color: #facc15; fill: #facc15; stroke: #facc15;
    }
  }
  ...
  &__foot {
    ...
    justify-content: space-between;
    gap: 10px;
    b { display: block; font-size: 14.5px; font-weight: 700; color: $dark; }
    span { display: block; font-size: 12.5px; color: $muted; margin-top: 2px; }
  }
...
.ck-cta {
  ...
  @include devices(md) { grid-template-columns: 1fr; gap: 24px; padding: 28px 22px; margin-top: 32px; }
  ...
  &__btn {
    ...
    :deep(.icon), :deep(svg) {
      ...
      color: #0d9488; fill: #0d9488; stroke: #0d9488;
    }
